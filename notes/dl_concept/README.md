...
- [特征缩放--Feature Scaling for input data](featurescale.md)【1.输入预处理】
- Networks(Functions)【2.[网络模型](../models/README.md)，前向传播】
- [Vanishing Gradient & Exploding Gradient](tidu.md)
  1. 预训练加微调
  2. 权重[初始化](init.md)
  3. 梯度剪切、权重正则（针对梯度爆炸）
  ...
  6. 使用残差结构
  7. 使用LSTM网络
- Loss function【3.损失函数】
- 🍀Adaptive Learning Rate【4.优化方式，反向传播】
- Tips
  - [固定随机化种子](random.md)
  - 评价标准（mAP……）
